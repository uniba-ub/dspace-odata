...
public class DataHandler {
	...
	public Entity readEntityData(EdmEntitySet edmEntitySet, List<UriParameter> keyParams) throws SolrServerException, IOException {
		Entity entity = null;
	...
	public EntityCollection createEntitySet(SolrDocumentList documentList, String entitySetName) {
		...
		for(SolrDocument solrDocument: documentList) {
			entitySet.getEntities().add(createEntity(createPropertyList(solrDocument, entitySetName, idIndex), entitySetName));
			idIndex ++;
		}
